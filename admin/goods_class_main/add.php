...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增商品品牌分類</span>
...
<form  class="form-horizontal" name="form1" method="post" action="../goods_class_main/add_ok.php" id="form" data-toggle="validator">
<div class="text-center txt_title"><strong>新增商品品牌分類</strong></div>
<div class="box-body">
