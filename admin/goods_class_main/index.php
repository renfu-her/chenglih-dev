...
//查詢
$sql="SELECT * 
FROM `goods_class_main` 
ORDER BY `goods_class_main_sort` ,`goods_class_main_no` DESC 
 ";
...
<form action="../goods_class_main/sort.php" method="post">
			...
			<table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe">
                ...
                <tbody>
                  ...
                  <tr>				  
                    ...
                    <th width="8%" align="center" bgcolor="#367FA9" class="txt_wt"><strong>NO</strong></th>

                    <th height="25" align="center" bgcolor="#367FA9" class="txt_wt"><strong>分類名稱</strong></th>
...
?>				  
                  ...
                  <tr>
                    ...
                    <td height="25" align="left" nowrap bgcolor="#FFFFFF" class="txt_12_gl" style="text-indent:3px;overflow:hidden;text-overflow:ellipsis;"><span class="text_item" style="text-indent:5px;">
                      ...
                      <?=$rows["goods_class_main_name"]; ?>
                      
                    </span></td>

                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><span class="text_item" style="text-indent:5px;">
                      
                      <input name="<?=$rows["goods_class_main_no"];?>" type="text" id="<?=$rows["goods_class_main_no"];?>" style="text-align:center" value="<?=$rows["goods_class_main_sort"];?>";>
					...
					<?PHP
					 ...
					 if($rows["goods_class_main_hide"]=="1")
                    ...
                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><a href="../goods_class_main/edit.php?no=<?=$rows["goods_class_main_no"];?>" class="a_movetop"><span class="label label-success"><i class="fa fa-edit"></i> 修改</span></a></td>

                    <td height="25" align="center"nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">
                           <span class="label label-danger a_movetop" onclick ="return del_<?=$no_id?>()"  ><i class="fa fa-trash"></i> 刪除</span>
                      <input id="link_<?=$no_id?>" type="hidden" value="del_ok.php?no=<?=$rows["goods_class_main_no"];?>"  />
                      <input id="delno_<?=$no_id?>" type="hidden" value="刪除品牌前請確認品牌下無任何商品，如有商品會導致後台查無品牌導致錯誤發生，您確認要刪除<?=$rows["goods_class_main_name"]; ?>嗎?"  />
