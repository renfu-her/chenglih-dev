...
<span class="txt_12_red">
 ...
 <table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe" style="table-layout:fixed">
<tbody>
  <tr>
	<th height="25" colspan="2" align="center" class="txt_20"><strong>產業新知設定</strong></th>
  </tr>
	<tr>
...
<tr>
  <td height="40" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	<tr>
	  <td bgcolor="#FFFFFF" >
	   <textarea name="content" id="content"><?=$rows["content"];?></textarea>
	   </td>
	</tr>
	<tr>
	  <td bgcolor="#FFFFFF" >
   		...
   		<div> 按鈕超連結：</div>
    	<div><input name="link"  id="title" type="link"  value="<?=$rows["link"];?>"  required="required" data-error="填寫按鈕超連結" /></div>
    	<DIV class="txt_12_gl1" >說明：請填寫完整超連結</DIV>
