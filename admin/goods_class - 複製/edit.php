...
<div class="box-header txt_12"><span>|| 後台管理介面 ></span>修改食品分類
</div>
...
<div class="text-center txt_title"><strong>修改食品分類
...
<div class="box-body">
	<div class="form-group">
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	<textarea name="keyword" wrap="virtual" id="keyword" style="height:100px;"><?=$rows["goods_class_keyword"]; ?></textarea>
      ...
      <div class="form-group">
    	...
    	<div class="col-md-10">       
    	 <textarea name="contact" wrap="virtual" id="contact"  style="height:100px;"><?=$rows["goods_class_contact"]; ?></textarea>
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">    
    	 <label>    	 
			<input name="sort" type="text" id="sort" value="<?=$rows["goods_class_sort"]; ?>" checked class="text-center" style="width: 40px;" ><span class="txt_12_gl1" >排序方式：數字越小排在越前面 </span>
		</label>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
...
<form  class="form-horizontal" method="post" action="../member - 複製/edit_pw_ok.php" name="form2" id="form2" data-toggle="validator">
