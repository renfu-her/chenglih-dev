...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增食品分類</span>
...
<div class="text-center txt_title"><strong>新增食品分類</strong></div>
<div class="box-body">
	<div class="form-group">
   		<label class="col-md-2 control-label">分類名稱：</label>
    	<div class="col-md-10">       
    	<input name="name"  id="name" type="text"  value=""  required="required" data-error="請填寫分類名稱" />
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	<textarea name="keyword" wrap="virtual" id="keyword" style="height:100px;"></textarea>
      ...
      <div class="form-group">
    	...
    	<div class="col-md-10">       
    	 <textarea name="contact" wrap="virtual" id="contact"  style="height:100px;"></textarea>
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">    
    	 <label>    	 
			<input name="sort" type="text" id="sort" value="0" checked class="text-center" style="width: 40px;" ><span class="txt_12_gl1" >排序方式：數字越小排在越前面 </span>
		</label>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
