...
//新增使用者
$sql="insert into goods_class (goods_class_name,goods_class_sort,goods_class_hide,goods_class_keyword,goods_class_contact)	
VALUES (:name,:sort,:hide,:keyword,:contact)";
