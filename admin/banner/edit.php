...
<div class="box-header txt_12"><span>|| 後台管理介面 > 修改首頁輪播</span>
...
<div class="text-center txt_title"><strong>修改首頁輪播<input type="hidden" name="edit_no" value="<?=$edit_no?>">   </strong></div>
<div class="box-body">
