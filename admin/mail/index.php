			...
			<table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe">
                ...
                <tbody>
                  ...
                  <tr>				  
                    ...
                    <th width="19%" height="25" align="center" bgcolor="#367FA9" class="txt_wt"><strong>發布IP</strong></th>
                  ...
                  <tr>
                   ...
                   <?=$rows["mail"]; ?>
                    ...
                    <span class="label label-danger a_movetop" onclick ="return del_<?=$no_id?>()"  ><i class="fa fa-trash"></i> 刪除</span>
                      <input id="link_<?=$no_id?>" type="hidden" value="del_ok.php?no=<?=$rows["no"];?>"  />
