...
<div class="box-header txt_12"><span>|| 後台管理介面 ></span>修改設備分類(產線)</div>
...
<div class="text-center txt_title"><strong>修改設備分類(產線)
  <input type="hidden" name="edit_no" value="<?=$edit_no?>"></strong></div>
<div class="box-body">
	<div class="form-group">
   		<label class="col-md-2 control-label">分類名稱：</label>
    	<div class="col-md-10">       
    	<input name="name"  id="name" type="text"  value="<?=$rows["goods_class3_name"]; ?>"  required="required" data-error="請填寫分類名稱" />
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">    
    	 <label for="hide"  style="cursor:pointer">
			<input name="hide" type="checkbox" id="hide" value="1" <?PHP if($rows["goods_class3_hide"]==1) echo 'checked'; ?> class="input_checkbox" ><span class="txt_12_gl1" style="position: relative; bottom: 7px;">說明：勾選後商品分類將展示於前台</span>
		</label>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
