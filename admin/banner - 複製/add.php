...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增banner輪播</span>
...
<div class="text-center txt_title"><strong>新增banner輪播</strong></div>
<div class="box-body">
<div class="form-group">
	...
	<div class="form-group">
   		<label class="col-md-2 control-label">上傳圖片(電腦版)：</label>
    	<div class="col-md-10">
    	<!--預覽區塊-->
    	<label for="imgfile">
     ...
     <div class="form-group">
   		<label class="col-md-2 control-label">上傳圖片(行動版)：</label>
    	<div class="col-md-10">
    	<!--預覽區塊-->
    	<label for="imgfile2">
      	...
      	<!--預覽區塊-->      
			<input name="imgfile2" type="file" id="imgfile2"  required="required" data-error="請選擇檔案" onChange="chkfile(this);" accept="image/gif, image/jpeg, image/png" />   
    ...
    <div class="form-group">
    	...
    	<div class="col-md-10">       
			<input name="link" id="link" type="text" value=""  data-error="請填寫超連結,需包含http://或https://" placeholder="超連結須完整，包含http://或https://" />
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    	    <select name="banner_href" id="banner_href"  data-error="請選擇開啟模式"> 
				<option value="無超連結" selected="selected">無超連結</option>                      
				<option value="當前視窗">當前視窗</option>
				<option value="開啟新頁">開啟新頁</option>                        
		    </select>
    		<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
     <div class="form-group">
    	...
    	<div class="col-md-10">       
    		<input name="sort" id="sort" type="text" value="0"  required="required" class="input_sort" />
