...
?>				  
                  ...
                  <tr>
                    ...
                    <td height="25" align="left" nowrap bgcolor="#FFFFFF" class="txt_12_gl" style="text-indent:3px;overflow:hidden;text-overflow:ellipsis;"><span class="text_item" style="text-indent:5px;">
                      ...
                      <?=$rows["goods_class4_name"]; ?>
                      
                    </span></td>

                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><span class="text_item" style="text-indent:5px;">
                      
                      <input name="<?=$rows["goods_class4_no"];?>" type="text" id="<?=$rows["goods_class4_no"];?>" style="text-align:center" value="<?=$rows["goods_class4_sort"];?>";>
                    ...
                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><a href="./edit.php?no=<?=$rows["goods_class4_no"];?>" class="a_movetop"><span class="label label-success"><i class="fa fa-edit"></i> 修改</span></a></td>

                    <td height="25" align="center"nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">
                           <span class="label label-danger a_movetop" onclick ="return del_<?=$no_id?>()"  ><i class="fa fa-trash"></i> 刪除</span>
                      <input id="link_<?=$no_id?>" type="hidden" value="del_ok.php?no=<?=$rows["goods_class4_no"];?>"  />
                      <input id="delno_<?=$no_id?>" type="hidden" value="確定要刪除<?=$rows["goods_class4_name"]; ?>"  />
