...
<div class="box-header txt_12"><span>|| 後台管理介面 ></span>修改關於我們
</div>
...
<div class="text-center txt_title"><strong>修改關於我們
  <input type="hidden" name="edit_no" value="<?=$edit_no?>"></strong></div>
<div class="box-body">
	<div class="form-group">
   		<label class="col-md-2 control-label">標題：</label>
    	<div class="col-md-10">       
    	<input name="name"  id="name" type="text"  value="<?=$rows["abouts_name"]; ?>"  required="required" data-error="請填寫標題" />
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10">    
    	 <label for="hide"  style="cursor:pointer">
			<input name="hide" type="checkbox" id="hide" value="1" <?PHP if($rows["abouts_hide"]==1) echo 'checked'; ?> class="input_checkbox" ><span class="txt_12_gl1" style="position: relative; bottom: 7px;">說明：勾選後商品分類將展示於前台</span>
		</label>
			<div class="help-block with-errors"></div>
   	 	</div>
     </div>	
      <div class="form-group">
    	...
    	<div class="col-md-10">       
    	 <textarea name="content" wrap="virtual" id="content"  style="height:100px;"><?=$rows["abouts_content"]; ?></textarea>        
   	 	</div>
     </div>	
     <!--按鈕-->
     <div  >
