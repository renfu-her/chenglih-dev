			...
			<table width="100%" cellpadding="1" cellspacing="1" class="table_01 stripe">
                ...
                <tbody>
                  ...
                  <tr>				  
                    ...
                    <th align="center" bgcolor="#367FA9" class="txt_wt"><strong>標題</strong></th>
...
?>				  
                  ...
                  <tr>
                    ...
                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><span class="text_item" style="text-indent:5px;">
                      ...
                      <input name="<?=$rows["abouts_no"];?>" type="text" id="<?=$rows["abouts_no"];?>" style="text-align:center" value="<?=$rows["abouts_sort"];?>";>
                    ...
                    <td height="25" align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl"><a href="./edit.php?no=<?=$rows["abouts_no"];?>" class="a_movetop"><span class="label label-success"><i class="fa fa-edit"></i> 修改</span></a></td>

                    <td height="25" align="center"nowrap="nowrap" bgcolor="#FFFFFF" class="txt_12_gl">
                           <span class="label label-danger a_movetop" onclick ="return del_<?=$no_id?>()"  ><i class="fa fa-trash"></i> 刪除</span>
                      <input id="link_<?=$no_id?>" type="hidden" value="del_ok.php?no=<?=$rows["abouts_no"];?>"  />
                      <input id="delno_<?=$no_id?>" type="hidden" value="確定要刪除<?=$rows["abouts_name"]; ?>"  />
