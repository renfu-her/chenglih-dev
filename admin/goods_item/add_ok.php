...
//奶素
if ( isset($_POST["home"]) && $_POST["home"] != '' ) { $home = '1'; }
else { $home = '0'; }
...
//新增使用者
$sql="insert into goods_item (	
goods_item_title,
goods_item_sort,
goods_item_class_main,
goods_item_class,
goods_item_class2,
goods_item_class3,
goods_item_class4,
...
:edittime
	...
	$result->bindValue(':money', $money, PDO::PARAM_INT);
	...
	$result->bindValue(':home', $home, PDO::PARAM_INT);
